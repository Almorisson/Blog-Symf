...
/* blog/show.html.twig */
class __TwigTemplate_4af2001e9f6f63b1d28d16ff80f5a4fc5ca8603fa49dcbccf5d087c4a752068f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <h3>";
        ...
        echo " - ";
        echo twig_escape_filter($this->env, $this->extensions['App\Twig\AppExtension']->str_rand(8), "html", null, true);
        echo "</h3>
    <h5>";
        // line 7
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 7, $this->source); })()), "text", [], "any", false, false, false, 7), "html", null, true);
        echo "</h5>
    <p> ";
        // line 8
        echo twig_escape_filter($this->env, $this->extensions['App\Twig\AppExtension']->priceFilter(500), "html", null, true);
        echo "</p>
    <p> ";
        // line 9
        ...
        echo " - ";
        echo twig_escape_filter($this->env, (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 9, $this->source); })()), "html", null, true);
        echo "</p>
";
    ...
    {
        return array (  109 => 9,  105 => 8,  101 => 7,  95 => 6,  90 => 5,  80 => 4,  59 => 3,  36 => 1,);
    }
...
{% block title %} MyBlog - {{ post.title }} {% endblock %}
{% block body %}
    <p>ID : {{ id }}</p>
    <h3>{{ post.title }} - {{ 8 | str_rand }}</h3>
    <h5>{{ post.text }}</h5>
    <p> {{ 500 | price }}</p>
    <p> {{ message }} - {{ locale }}</p>
{% endblock %}
", "blog/show.html.twig", "/home/mor/PersonalProjects/Symfony4/udemy-symfony4/templates/blog/show.html.twig");
    }
}
